...
ATP_ThirdPersonCharacter::ATP_ThirdPersonCharacter()
{
	...
	PawnAttributeAsset = LoadObject<UPawnAttributeAsset>(nullptr, TEXT("/Script/Assignment_2.PawnAttributeAsset'/Game/Assignment2/DataAssets/ThirdPersonAsset.ThirdPersonAsset'"));
}
